    ...
    public partial class ResponseOptionUsage : Form
    {
        ...
        private bool Dirty
        {
            ...
            set
            {
                ...
                if (_dirty)
                {
                    lblTitle.Text = "Response Options Usage*";
                }
                else
                {
                    lblTitle.Text = "Response Options Usage";
        ...
        public ResponseOptionUsage()
        {
            InitializeComponent();

            ResponseSets = DBAction.GetResponseSets("RespName");
        ...
        private void ResponseOptionUsage_Load(object sender, EventArgs e)
        {
            ...
            Color temp = Color.FromArgb(0xE8D99B);
        ...
        private void cmdSearchClip_Click(object sender, EventArgs e)
        {
            ...
            bs.DataSource = ResponseSets.Where(x => x.RespList.Contains(searchTerm));
