...
namespace SDIFrontEnd
{
    ...
    {
        public ImportType TypeOfImport { get; set; }
        ...
        public string TargetSurvey { get; set; }
        public Language TargetLanguage { get; set; }

        public bool Bilingual { get; set; }

        public List<Translation> importedTranslations;
        public List<Translation> empties;
        public List<Translation> duplicates;

        public TranslationImporter()
        {
            TargetSurvey = string.Empty;
            ...
            using (WordprocessingDocument wdDoc = WordprocessingDocument.Open(fileName, false))
            {
                ...
                foreach (Table t in tables)
                {
                    ...
                    foreach (TableRow row in rows)
                    {
                        ...
                        Translation existingT = DBAction.GetSurveyTranslation(TargetSurvey, varname, TargetLanguage.LanguageName) ?? new Translation();
                        tq.ID = existingT.ID;
                        tq.QID = DBAction.GetQuestionID(TargetSurvey, varname);
                        tq.LanguageName = TargetLanguage;
                        tq.Survey = TargetSurvey;
                        tq.VarName = varname;
        ...
        private void SaveMultiTranslation()
        {
